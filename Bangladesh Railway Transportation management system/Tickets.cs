...
namespace Bangladesh_Railway_Transportation_management_system
{
    ...
    {
        private SqlConnection con = new SqlConnection("Data Source=FAHIM\\SQLEXPRESS;Initial Catalog=BangladeshRailwayManagementDB;Integrated Security=True;Encrypt=False");
        ...
        private void book_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection("Data Source=FAHIM\\SQLEXPRESS;Initial Catalog=BangladeshRailwayManagementDB;Integrated Security=True;Encrypt=False"))
            {
                connection.Open();
       ...
       void BindData()
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection("Data Source=FAHIM\\SQLEXPRESS;Initial Catalog=BangladeshRailwayManagementDB;Integrated Security=True;Encrypt=False"))
            {
                ...
                string deleteQuery = "DELETE FROM [dbo].[bookinglist]\r\n      WHERE [TrainNo]='" + trainnocombobox.Text+ "' and [username]='"+usernametxt.Text+"'";
