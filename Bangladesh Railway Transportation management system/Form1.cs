...
namespace Bangladesh_Railway_Transportation_management_system
{
    public partial class homepage : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=FAHIM\SQLEXPRESS;Initial Catalog=BangladeshRailwayManagementDB;Integrated Security=True;Encrypt=False");
        ...
        private void loginclick(object sender, EventArgs e)
        {
                ...
                string query = @"SELECT [username], [password], 'Admin' AS [UserType] FROM [BangladeshRailwayManagementDB].[dbo].[admindetails] WHERE [username] = '" + username + "' AND [password] = '" + password + @"'
                     UNION ALL
                     SELECT [username], [password], 'User' AS [UserType] FROM [BangladeshRailwayManagementDB].[dbo].[userdetails] WHERE [username] = '" + username + "' AND [password] = '" + password + "'";
